#IMPORTANT: Add the following 2 lines to /boot/config.txt to generate additional i2c busses 3 and 4
...
bus3=smbus.SMBus(3) #Additional configured in config.txt 12c bus
bus4=smbus.SMBus(4) #Additional configured in config.txt 12c bus
address=0x25
scale_factor=255/60
